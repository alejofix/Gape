...
class Monitor {
     ...
     * @var string
     */
    private $dataTemplateCSS = 'position: fixed; top: 240px; left: 240px; box-shadow:0 0 8px #555; background: #FFF; padding: 5px; color:#000 !important; z-index: 9999';
    ...
    {
        $table = '<table><thead><tr style="background:#EEE;"><td style="padding:5px;">&nbsp;</td><td style="padding:5px;">Tiempo</td><td style="padding:5px;">Memoria</td><td style="padding:5px;">Archivos</td><td style="padding:5px; text-align:right">Clases</td><td style="padding:5px; text-align:right">%</td></tr></thead><tbody>';
