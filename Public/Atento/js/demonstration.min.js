function moneyRandom(){
	var e=$(".stats .icon-money").parent().find(".details .big"),t=parseFloat(e.html().replace("$","").replace(",",".")),n=Math.random()*10,r=1;
	n>=5&&(r=-1);
	...
	function orderRandom(){
		var e=$(".stats .icon-shopping-cart").parent().find(".details .big"),t=parseInt(e.html()),n=Math.random()*10,r=1;n>=5&&(r=-1);
		t+=r*Math.floor(Math.random()*3);
		e.html(t);setTimeout(function(){
			orderRandom()
			},2500)
	}
	
	function currentTime(){
		var e=$(".stats .icon-calendar").parent(),t=new Date,n=["Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre"],r=["Domingo","Lunes","Martes","Miercoles","Jueves","Viernes","Sabado"];
